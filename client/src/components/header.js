...
class Header extends Component {
  ...
  render() {
    return (
      ...
      <nav className="navbar navbar-inverse bg-custom-2 navbar-toggleable-md fixed-top">
        <div className="container">
          ...
          <Link className="navbar-brand" to="/"><strong>Interview Articles NIT_JSR</strong></Link>
          ...
          <div className="collapse navbar-collapse" id="navbarsExampleContainer">
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item">
                <a className="nav-link" target="_blank" rel="noopener noreferrer" href="https://github.com/venk-bit">GitHub</a>
              </li>
            </ul>
